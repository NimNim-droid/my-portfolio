  ...
  return (
    <Section className="py-16 md:py-24">
      <div className="space-y-16">
        ...
        {/* Main Philosophy Headline & Paragraphs (Scroll Reveal) */}
        ...
        {/* 4 Focus Cards Grid (Staggered Scroll Reveal) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-neutral-200/80 dark:border-neutral-800">
          {highlightPillars.map((pillar, index) => (
            <ScrollReveal
              ...
              distance={16}
            >
              <div className="space-y-2 p-5 rounded-xl border border-neutral-200/60 dark:border-neutral-800/60 bg-white/60 dark:bg-neutral-900/40 hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-300">
